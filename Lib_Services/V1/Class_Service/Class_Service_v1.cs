...
namespace Lib_Services.V1.Class_Service
{
    public class Class_Service_v1 : IClass_Service_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> InsertAsync(string name_ClassSchool)
        {
            throw new NotImplementedException();
        }

        public Task<List<Class_Select_v1>> SelectAll()
        {
            throw new NotImplementedException();
        }

        public Task<Class_Select_v1> SelectById(int id)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> UpdateAsync(Class_Update_v1 request)
        {
            throw new NotImplementedException();
        }
    }
