...
namespace Lib_Services.V1.School_Service
{
    public class School_Service_v1 : ISchool_Service_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> InsertAsync(School_Insert_v1 request)
        {
            throw new NotImplementedException();
        }

        public Task<List<School_SelectAll_v1>> SelectAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> UpdateAsync(School_Update_v1 request)
        {
            throw new NotImplementedException();
        }
    }
