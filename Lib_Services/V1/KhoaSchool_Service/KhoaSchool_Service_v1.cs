...
namespace Lib_Services.V1.KhoaSchool_Service
{
    public class KhoaSchool_Service_v1 : IKhoaSchool_Service_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> InsertAysnc(KhoaSchool_Insert_v1 reques)
        {
            throw new NotImplementedException();
        }

        public Task<List<KhoaSchool_Select_v1>> SelectAll()
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> UpdateAysnc(KhoaSchool_Update_v1 reques)
        {
            throw new NotImplementedException();
        }
    }
