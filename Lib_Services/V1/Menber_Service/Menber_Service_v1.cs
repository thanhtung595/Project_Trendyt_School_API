...
namespace Lib_Services.V1.Menber_Service
{
    public class Menber_Service_v1 : IMenber_Service_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> Delete(int id_member)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> InsertAsync(MenberSchool_Insert_v1 request)
        {
            throw new NotImplementedException();
        }

        public Task<Member_Profile_v1> Profile()
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<Menber_SclectAll_v1>> SelectAllAsync()
        {
            throw new NotImplementedException();
        }
    }
