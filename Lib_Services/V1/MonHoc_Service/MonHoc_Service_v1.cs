...
namespace Lib_Services.V1.MonHoc
{
    public class MonHoc_Service_v1 : IMonHoc_Service_v1
    {
        ...
        //{
        //    tbMenberSchool menberManager = await _tokenService_V2.Get_Menber_Token();
        //    return await _monHoc_Repository_V1.GetAll(menberManager);
        ...
        //}
        public Task<Status_Application> Edit(MonHoc_Update_v1 request)
        {
            throw new NotImplementedException();
        }

        public Task<List<MonHoc_SelectAll_v1>> GetAll()
        {
            throw new NotImplementedException();
        }

        public Task<MonHocSelectById_v1> GetById(int id_MonHoc)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> Insert(tbMonHoc monHoc)
        {
            throw new NotImplementedException();
        }
    }
