...
namespace Lib_Repository.V1.Menber_Repository
{
    public class Menber_Repository_v1 : IMenber_Repository_v1
    {
        ...
        //     }
        //     #endregion
        public Task<Status_Application> Delete(tbMenberSchool menberSchool)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> InsertAsync(tbMenberSchool menberSchool)
        {
            throw new NotImplementedException();
        }

        public Task<Member_Profile_v1> Profile(int id_Member)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> SchoolMenberUpdateAsync(School_Menber_Update_v1 request)
        {
            throw new NotImplementedException();
        }

        public Task<List<Menber_SclectAll_v1>> SelectAllAsync(tbMenberSchool menberManager)
        {
            throw new NotImplementedException();
        }
    }
