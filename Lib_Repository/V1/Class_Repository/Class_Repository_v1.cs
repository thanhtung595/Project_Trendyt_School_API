...
namespace Lib_Repository.V1.Class_Repository
{
    public class Class_Repository_v1 : IClass_Repository_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> InsertAsync(tbClassSchool classSchool)
        {
            throw new NotImplementedException();
        }

        public Task<List<Class_Select_v1>> SelectAll(tbMenberSchool menberSchoolManager)
        {
            throw new NotImplementedException();
        }

        public Task<Class_Select_v1> SelectById(tbMenberSchool menberSchoolManager, int idClass)
        {
            throw new NotImplementedException();
        }
