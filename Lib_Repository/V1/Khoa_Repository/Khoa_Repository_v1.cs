...
namespace Lib_Repository.V1.Khoa_Repository
{
    public class Khoa_Repository_v1 : IKhoa_Repository_v1
    {
        ...
        //}
        //#endregion
        public Task<Status_Application> InsertAysnc(tbKhoaSchool khoaSchool)
        {
            throw new NotImplementedException();
        }

        public Task<List<KhoaSchool_Select_v1>> SelectAll(int id_School)
        {
            throw new NotImplementedException();
        }

        public Task<Status_Application> UpdateAysnc(KhoaSchool_Update_v1 khoaSchool)
        {
            throw new NotImplementedException();
        }
    }
