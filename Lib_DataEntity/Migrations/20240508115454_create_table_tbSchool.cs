...
{
    /// <inheritdoc />
    public partial class create_table_tbSchool : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description_School = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    adderss_School = table.Column<string>(type: "nvarchar(max)", nullable: true),
