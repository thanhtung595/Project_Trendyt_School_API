...
{
    /// <inheritdoc />
    public partial class add_table_tbAccount : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sex_User = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    email_User = table.Column<string>(type: "varchar(max)", nullable: false),
                    phone_User = table.Column<string>(type: "varchar(max)", nullable: true),
