...
namespace Lib_DataEntity.Migrations
{
    ...
    [Migration("20240125082501_add_table_tbMonHocClass_Student")]
    partial class add_table_tbMonHocClass_Student
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbBuoiHoc", b =>
                {
                    ...
                    b.Property<string>("name_BuoiHoc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbBuoiHoc_MonHoc", b =>
                {
                    b.Property<int>("id_BuoiHoc_MonHoc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("id_BuoiHoc_MonHoc"));

                    b.Property<int>("id_BuoiHoc")
                        .HasColumnType("int");

                    b.Property<int>("id_ClassSchool_MonHoc")
                        .HasColumnType("int");

                    b.HasKey("id_BuoiHoc_MonHoc");

                    b.HasIndex("id_BuoiHoc");

                    b.HasIndex("id_ClassSchool_MonHoc");

                    b.ToTable("tbBuoiHoc_MonHoc");
                });
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbClassSchool_MonHoc", b =>
                {
                    b.Property<int>("id_ClassSchool_MonHoc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("id_ClassSchool_MonHoc"));
                    ...
                    b.HasKey("id_ClassSchool_MonHoc");

                    b.HasIndex("id_ClassSchool");

                    b.HasIndex("id_MonHoc");

                    b.ToTable("tbClassSchool_MonHoc");
                });
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbMonHocClass_Student", b =>
                {
                    b.Property<int>("id_MonHocClass_Student")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbBuoiHoc_MonHoc", b =>
                {
                    b.HasOne("App_Models.Models_Table_CSDL.tbBuoiHoc", "tbBuoiHoc")
                        .WithMany()
                        .HasForeignKey("id_BuoiHoc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App_Models.Models_Table_CSDL.tbClassSchool_MonHoc", "tbClassSchool_MonHoc")
                        .WithMany()
                        .HasForeignKey("id_ClassSchool_MonHoc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("tbBuoiHoc");

                    b.Navigation("tbClassSchool_MonHoc");
                });
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbClassSchool_MonHoc", b =>
                {
                    ...
                    b.HasOne("App_Models.Models_Table_CSDL.tbMonHoc", "tbMonHoc")
                        .WithMany()
