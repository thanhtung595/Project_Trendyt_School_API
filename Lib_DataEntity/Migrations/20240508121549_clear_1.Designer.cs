...
namespace Lib_DataEntity.Migrations
{
    ...
    [Migration("20240508121549_clear_1")]
    partial class clear_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_Role = new Guid("01c0ea9c-bdd9-42ba-bb90-3e7dbec1b137"),
                            name_Role = "admin"
                        },
                        new
                        {
                            id_Role = new Guid("653947d1-1aa2-4624-adc7-fbd35cf5a142"),
                            name_Role = "guest"
                        });
                });
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbRoleSchool", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_RoleSchool = new Guid("99fd4ba6-91c7-459f-a0db-0d64604f96ae"),
                            name_Role = "school management"
                        },
                        new
                        {
                            id_RoleSchool = new Guid("837bc119-e77e-4eb9-bbc6-b09978e8ad48"),
                            name_Role = "industry management"
                        },
                        new
                        {
                            id_RoleSchool = new Guid("8cd6d7fd-b458-4cdc-afd5-42b0786593f1"),
                            name_Role = "secretary management"
                        },
                        new
                        {
                            id_RoleSchool = new Guid("d0a67264-30dc-4fc9-afd9-55834d64220a"),
                            name_Role = "teacher"
                        },
                        new
                        {
                            id_RoleSchool = new Guid("48b0622a-7eb4-4b10-88de-b4285768b64b"),
                            name_Role = "student"
                        });
                });
            ...
            modelBuilder.Entity("App_Models.Models_Table_CSDL.tbTypeAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_TypeAccount = new Guid("79ff0eb5-0a6a-4b21-bd7e-53dc9391527a"),
                            name_TypeAccount = "account name"
                        },
                        new
                        {
                            id_TypeAccount = new Guid("bf682274-7606-4042-909d-4f3d2f21f662"),
                            name_TypeAccount = "gmail"
                        },
                        new
                        {
                            id_TypeAccount = new Guid("b60476d5-7ecd-42b4-ae54-0b2653b9a259"),
